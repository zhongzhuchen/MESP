...
[~, xb, ~] = obj.Knitro_DDFact_comp(x0,s,Gamma2);
[fval_a1, dx_a1, info_a1] = obj.DDFact_obj(xa,s,Gamma1);
[fval_b2, dx_b2, info_b2] = obj.DDFact_comp_obj(xb,s,Gamma2);
[fval_a2, dx_a2, info_a2] = obj.DDFact_comp_obj(xa,s,Gamma2);
...
elseif dalpha_b <=0
    ...
    while b-a > 1e-6
        ...
        alpha=(a+b)/2;
        obj_fn = @(x) obj.mix_DDFact_DDFact_comp_obj_knitro(x,s,Gamma1,Gamma2,alpha);
        ...
        [fval2, dx2, info2] = obj.DDFact_comp_obj(x,s,Gamma2);

...
[~, xa, ~] = obj.Knitro_DDFact_comp(x0,s,Gamma1);
[~, xb, ~] = obj.Knitro_Linx(x0,s,Gamma2);
[fval_a1, dx_a1, info_a1] = obj.DDFact_comp_obj(xa,s,Gamma1);
[fval_b2, dx_b2, info_b2] = obj.Linx_obj(xb,s,Gamma2);
[fval_a2, dx_a2, info_a2] = obj.Linx_obj(xa,s,Gamma2);
[fval_b1, dx_b1, info_b1] = obj.DDFact_comp_obj(xb,s,Gamma1);
